...
const AdminDashboard = () => (
  <>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <StatCard icon={Users} label="Total Users" value="248" accent="gradient-primary" />
      ...
      <Card className="p-6 shadow-card">
        ...
        <div className="space-y-4">
          {[
            ...
            { dept: "IT", students: 80, faculty: 6, color: "gradient-accent" },
...
const FacultyDashboard = () => (
  <>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <StatCard icon={BookOpen} label="My Subjects" value="3" accent="gradient-primary" />
    ...
    <Card className="p-6 shadow-card">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          <Card key={s.name} className="p-4 border shadow-card hover:shadow-card-hover transition-shadow cursor-pointer">
...
const StudentDashboard = () => (
  <>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <StatCard icon={BookOpen} label="Enrolled Subjects" value="5" accent="gradient-primary" />
    ...
    <Card className="p-6 shadow-card">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[
          ...
          { name: "Data Structures Laboratory", exps: 12, done: 5, color: "gradient-accent" },
